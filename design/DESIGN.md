...
The Game Player will load a new starting window with buttons that are appropriate for the games. It will have 5 options:
...
- **Load Game**
This button leads to a FileChooser that allows the user to select a game to play. 
