...
public class EntitySaver
{
	...
	/**
	 * Generates a XML Element given a list of entities. Also saves the images
	 * of all entities in the process.
	 * 
	 * @param entities
	 *            : entities to save
	...
	/**
	 * Converts an entity into an element node to be used in XML. Also saves the
	 * entity's image into game resources.
	 * 
	 * @param entity
	 *            : Entity to be converted into element
	 * @param gameFolderPath
	...
	protected Element getEntityAsXML(Entity entity, String gameFolderPath)
	{
		 ...
		 * FileOutputStream("filename" + entity.getName() + ".txt"))) {
		 * out.print(xmlString); } catch (FileNotFoundException e) { // TODO
