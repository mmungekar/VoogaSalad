...
public class Settings extends View {
	...
	private void setup() {
		...
		songField = new LabeledField(workspace, "SongLabel", fileName(workspace.getGame().getSongPath()), false);
		VBox musicBox = buttonBox("MusicSelect",
		...
		settingsContainer.getChildren().addAll(musicBox, new Separator(), imageBox);
