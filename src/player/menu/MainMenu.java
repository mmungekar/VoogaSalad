...
public class MainMenu extends AbstractMenu {
	...
	public void addElements() {
		...
		Tile optionsTile = new Tile(getPolyglot().get("OptionsButton", Case.TITLE), "green", e -> getStage()
				.setScene(new OptionsMenu(getStage(), getGame(), getMediaManager(), getPolyglot(), getResources()).createScene(420, 600)));
		Tile infoTile = new Tile(getPolyglot().get("InfoButton", Case.TITLE), "blue", e -> getStage()
				.setScene(new InfoMenu(getStage(), getGame(), getMediaManager(), getPolyglot(), getResources()).createScene(420, 600)));
